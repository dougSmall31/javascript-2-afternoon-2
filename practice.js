...
function divider (numbersArray){
  ...
  for (i=0; i<numbersArray.length;i++){
    ...
    else oddNums.push(numbersArray[i]);
  }
  return [evenNums,oddNums];
}
//"foreach!! numbersArray.forEach(function(){numbersArray[i] % 2 === 0 ? evenNums.push(numbersArray[i]) : oddNums.push(numbersArray[i]);)return [even,odd];
